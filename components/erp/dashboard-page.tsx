        ...
        {lowStock.length === 0 ? (
          ...
          lowStock.map((product) => (
            <div key={product.id} className="flex items-center justify-between p-3 rounded-lg bg-warning/5 border border-warning/20">
              ...
              <div className="text-right">
                <p className="text-sm font-bold text-warning">{product.stock} left</p>
...
export function DashboardPage() {
  ...
  const { orders, fetchOrders, getTotalRevenue, getPendingOrdersCount } = useOrderStore()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="glass-card p-4 text-center">
          <p className="text-3xl font-bold text-primary">
            {Math.round(orders.reduce((sum, o) => sum + o.items.reduce((s, i) => s + i.quantity, 0), 0))}
          </p>
