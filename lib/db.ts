  ...
  try {
    ...
    if (parseInt(productsCount.rows[0].count) === 0) {
      await pool.query(`
        ...
        ('11', 'CTN-012', 'Polo Shirt', 'Polo shirt', 49.99, 0, 'Tops', 'https://www.harmontblaine.com/on/demandware.static/-/Sites-harmont-m-catalog/default/dwc73c149d/images/large/LN1010N21054_999_1.jpg', 20),
        ('12', 'CTN-013', 'Trench Coat', 'Waterproof trench coat', 189.99, 7, 'Outerwear', 'https://images.unsplash.com/photo-1544923246-77307dd628b7?w=400&h=400&fit=crop', 5)
      `);
    }
